...
const CACHE = "offshore-os-v17";
const SHELL = ["./", "./index.html", "./core.css?v=4", "./config.js?v=13", "./bus.js?v=3",
  ...
  "./mod-agents.js?v=3", "./mod-showcase.js?v=2", "./boot.js?v=12", "./fx.js?v=7", "./manifest.json", "./icon.svg", "./icon-maskable.svg"];
