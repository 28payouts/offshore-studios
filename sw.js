...
const CACHE = "offshore-os-v14";
const SHELL = ["./", "./index.html", "./core.css?v=4", "./config.js?v=11", "./bus.js?v=3",
  ...
  "./mod-agents.js?v=3", "./boot.js?v=11", "./fx.js?v=6", "./manifest.json", "./icon.svg", "./icon-maskable.svg"];
