...
const CACHE = "offshore-os-v16";
const SHELL = ["./", "./index.html", "./core.css?v=4", "./config.js?v=12", "./bus.js?v=3",
  "./mod-home.js?v=8", "./mod-roundtable.js?v=4", "./mod-claude.js?v=4", "./mod-livemind.js?v=7",
  "./mod-botlab.js?v=2", "./mod-academy.js?v=3", "./mod-clients.js?v=4", "./mod-agency.js?v=5",
  "./mod-agents.js?v=3", "./mod-showcase.js?v=1", "./boot.js?v=12", "./fx.js?v=7", "./manifest.json", "./icon.svg", "./icon-maskable.svg"];
