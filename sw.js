...
const CACHE = "offshore-os-v13";
const SHELL = ["./", "./index.html", "./core.css?v=4", "./config.js?v=10", "./bus.js?v=3",
  ...
  "./mod-agents.js?v=3", "./boot.js?v=10", "./fx.js?v=6", "./manifest.json", "./icon.svg", "./icon-maskable.svg"];
