  ...
  mount(el, user) {
    ...
    const LINEAGE = [
      ...
      { v: "LIVE MIND v6", f: "frozen 27 Jul 2026", tag: "CURRENT · FROZEN", note: "One machine, four engines. The build everything else fed into.",
        stats: [["18y result", "$100k → $10,015,774"], ["Trades", "6,164"], ["Win rate", "56.2%"], ["Profit factor", "1.66"], ["Max DD", "16.9%"], ["CAGR", "28.5%"]],
    ...
    const CORE = [
      { key: "livemind", name: "THE LIVE MIND", sub: "trading bot · " + LINEAGE.length + " versions built", accent: "#00e8d0", art: ART.livemind,
        chip: ["FROZEN 27 JUL", "ok"], brief: [
          ...
          ["◈", "Verified record", "$100k → $10.02M / 18y backtest"],
    ...
    const liveMindView = () => `
      ...
      <div class="cards reveal">
        ...
        <div class="card"><div class="stat"><div class="k">Verified 18y</div><div class="v pos">$10.02M</div><div class="s">$100k start · bar-by-bar backtest</div></div></div>
      ...
      <div class="cards reveal" style="margin-top:18px;grid-template-columns:1fr 1fr">
        <div class="card"><h3>Where this project goes next</h3><p class="cs">in order, and honestly</p>
          <div style="font-size:12.5px;color:var(--mut);line-height:2.1">
            ...
            ② 60 verified sim trades → compare to the 56.2% record<br>
    ...
    const wireDesk = p => {
      ...
      const ctxFor = () => p.key === "livemind"
        ? "Project: THE LIVE MIND trading bot. " + LINEAGE.length + " versions built, current v6 (four engines), frozen 27 Jul 2026. Verified backtest: $100k→$10,015,774 over 18y, 6,164 trades, 56.2% win, PF 1.66, max DD 16.9%. Zero live fills — sim gate 0/60 awaiting the TradingView webhook."
        : p.key === "academy"
